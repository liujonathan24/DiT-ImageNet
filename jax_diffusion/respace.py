...
class _WrappedModel:
    ...
    def __call__(self, x, ts, **kwargs):
        map_tensor = jnp.array(self.timestep_map, dtype=jnp.int32)
        ...
        # The model's forward_with_cfg expects cfg_scale directly.
        return self.model.forward_with_cfg(x, new_ts, y, cfg_scale, train=False)